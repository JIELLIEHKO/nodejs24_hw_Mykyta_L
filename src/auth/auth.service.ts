...
export class AuthService {
  ...
  constructor(
    ...
    this.logger.log('JWT_ACCESS_SECRET: ' + this.configService.get<string>('JWT_ACCESS_SECRET'));
    this.logger.log('JWT_REFRESH_SECRET: ' + this.configService.get<string>('JWT_REFRESH_SECRET'));
  }
